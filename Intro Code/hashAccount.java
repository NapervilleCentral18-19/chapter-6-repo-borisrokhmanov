...
public class hashAccount
{
    ...
    Account p3 = new Account ("Liz Wilson" ,1349, 2034.52, 1);
    Account p4 = new Account ("Homer Simpson" ,0001, 1090.45, 1);
    ...
    Account p9 = new Account ("Eric Wilhelm" ,3208, 3420.75, 1);
    Account p10 = new Account ("Megan MulCahey" ,4568, 9041.49, 1);
